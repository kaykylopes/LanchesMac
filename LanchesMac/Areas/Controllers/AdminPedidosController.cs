...
namespace LanchesMac.Areas.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        // GET: Controllers/AdminPedidos
        public async Task<IActionResult> Index()
        {
            return View(await _context.Pedidos.ToListAsync());
        }

        // GET: Controllers/AdminPedidos/Details/5
        ...
        // GET: Controllers/AdminPedidos/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Controllers/AdminPedidos/Create
        ...
        // GET: Controllers/AdminPedidos/Edit/5
        ...
        // POST: Controllers/AdminPedidos/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Controllers/AdminPedidos/Delete/5
        ...
        // POST: Controllers/AdminPedidos/Delete/5
